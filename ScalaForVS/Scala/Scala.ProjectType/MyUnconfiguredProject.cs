...
namespace VSScala
{
    ...
    [ProjectTypeRegistration(VsPackage.ProjectTypeGuid, "Scala", "#2", ProjectExtension, Language, resourcePackageGuid: VsPackage.PackageGuid, PossibleProjectExtensions = ProjectExtension, ProjectTemplatesDir = @"..\..\Templates\Projects\MyCustomProject")]
    ...
    internal class MyUnconfiguredProject
    {
        ...
        /// </summary>
        internal const string ProjectExtension = "iml";
        ...
        /// </remarks>
        internal const string UniqueCapability = "Scala";
